 ...
 * @author shweta
 */
public class Singer3 extends javax.swing.JFrame {
    int s=0;
    public static int score3;

    /**
     * Creates new form Singer3
     */
    public Singer3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/armaan malik-1.jpg"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/armaan malik-2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 284, 350, 82));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/armaan malik-3.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 366, 350, 61));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/armaan malik-4.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 427, 350, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/armaan malik-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 487, 350, 66));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("Armaan malik"))
        {
            ...
            jLabel5.setVisible(true);
            jLabel12.setVisible(true);
            jTextField1.setText("Armaan Malik");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Singer3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
