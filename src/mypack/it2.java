 ...
 * @author shweta
 */
public class it2 extends javax.swing.JFrame {
    int s=0;
    public static int score2;

    /**
     * Creates new form it2
     */
    public it2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, 510, 70));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Elon_Musk-1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 134));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Elon_Musk-2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 284, 350, 66));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Elon_Musk-3.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, 350, 51));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Elon_Musk-4.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 401, 350, 42));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Elon_Musk-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 443, 350, 116));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("elon musk"))
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(it2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
