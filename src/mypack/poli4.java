 ...
 * @author shweta
 */
public class poli4 extends javax.swing.JFrame {
    int s=0;
public static int score4;

    /**
     * Creates new form poli4
     */
    public poli4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/rajiv_gandhi-9-1.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, 106));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/rajiv_gandhi-9-2.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 256, -1, 50));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/rajiv_gandhi-9-3.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 306, -1, 44));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/rajiv_gandhi-9-5.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 384, -1, 166));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/rajiv_gandhi-9-4.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, -1, 34));
        ...
        jLabel17.setText("By profession he was a");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 380, -1, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 0, 0));
        jLabel19.setText("pilot and served as 7th ");
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 420, -1, -1));

        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 0, 0));
        jLabel25.setText("Prime Minister.");
        getContentPane().add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 450, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(a.equalsIgnoreCase("Rajiv gandhi"))
        {
            ...
            jTextField1.setText("Rajiv Gandhi");
            jLabel4.setVisible(true);
            jLabel5.setVisible(true);
            jLabel16.setVisible(true);
            jLabel7.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(poli4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
