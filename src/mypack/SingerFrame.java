...
public class SingerFrame extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        int a = Singer1.score1+Singer2.score2+Singer3.score3+Singer4.score4+Singer5.score5;
        String score = Integer.toString(a);
        jLabel10.setText(score);
        String name = Login.user;
        int score1 = Singer1.score1;
        int score2 = Singer2.score2;
        int score3 = Singer3.score3;
        int score4 = Singer4.score4;
        int score5 = Singer5.score5;
        int total = a;
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/game","root","");
           String x = "insert into singer values('"+name+"','"+score1+"','"+score2+"','"+score3+"','"+score4+"','"+score5+"','"+total+"')";
