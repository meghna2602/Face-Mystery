...
public class itFrame extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        int a = it1.score1+it2.score2+it3.score3+it4.score4+it5.score5;
        String score = Integer.toString(a);
        jLabel10.setText(score);
        String name = Login.user;
        int score1 = it1.score1;
        int score2 = it2.score2;
        int score3 = it3.score3;
        int score4 = it4.score4;
        int score5 = it5.score5;
        int total = a;
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/game","root","");
           String x = "insert into it values('"+name+"','"+score1+"','"+score2+"','"+score3+"','"+score4+"','"+score5+"','"+total+"')";
