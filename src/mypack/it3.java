 ...
 * @author shweta
 */
public class it3 extends javax.swing.JFrame {
    int s=0;
    public static int score3;

    /**
     * Creates new form it3
     */
    public it3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/steve-jobs-apple-1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 112));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/steve-jobs-apple-3.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 344, 350, 44));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/steve-jobs-apple-2.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 262, 350, 82));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/steve-jobs-apple-4.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 388, 350, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/steve-jobs-apple-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 438, 350, 112));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, -1, 20));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("steve jobs"))
        {
            ...
            jLabel5.setVisible(true);
            jLabel12.setVisible(true);
            jTextField1.setText("Steve Jobs");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(it3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
