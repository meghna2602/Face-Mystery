 ...
 * @author shweta
 */
public class it5 extends javax.swing.JFrame {
    int s=0;
    public static int score5;

    /**
     * Creates new form it5
     */
    public it5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Guess the Entrepreneur");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 510, 70));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/sundar-pichai-google ceo-1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 124));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/sundar-pichai-google ceo-2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 274, 350, 62));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/sundar-pichai-google ceo-4.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 372, 350, 50));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/sundar-pichai-google ceo-3.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 336, 350, 36));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/sundar-pichai-google ceo-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 422, 350, 128));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, -1, 30));

        jLabel10.setFont(new java.awt.Font("Verdana", 1, 24)); // NOI18N
        jLabel10.setText("lfttym");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, 100, -1));
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/finalexit.png"))); // NOI18N
        jLabel21.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel21MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 20, -1, -1));
        ...
        jLabel17.setText("He is listed as either primary ");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 380, -1, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 0, 0));
        jLabel19.setText("or co-inventor for 346 US");
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, -1, -1));

        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 0, 0));
        jLabel25.setText("patents related to a ");
        getContentPane().add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 430, -1, -1));

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 0, 0));
        jLabel26.setText("range of technologies");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("Sundar pichai"))
        {
            ...
            jLabel5.setVisible(true);
            jLabel12.setVisible(true);
            jTextField1.setText("Sundar Pichai");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(it5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
