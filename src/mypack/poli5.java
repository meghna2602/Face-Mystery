 ...
 * @author shweta
 */
public class poli5 extends javax.swing.JFrame {
    int s=0;
    public static int score5;

    /**
     * Creates new form poli5
     */
    public poli5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj3.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 346, 350, 58));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 118));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj-4.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 404, 350, 56));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 268, 350, 78));

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj5.jpg"))); // NOI18N
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 460, -1, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, 460, 70));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/apj-4.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 404, 350, 56));
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/buttons22.png"))); // NOI18N
        jLabel19.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel19MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 460, -1, -1));
        ...
        jLabel17.setText("He was known as the ");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 400, -1, 30));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(255, 0, 0));
        jLabel20.setText("‘Missile Man’ of India");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 440, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("APJ abdul kalam"))
        {
            ...
            jLabel5.setVisible(true);
            jLabel13.setVisible(true);
            jTextField1.setText("APJ Abdul Kalam");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(poli5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
