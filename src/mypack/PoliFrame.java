...
public class PoliFrame extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        int a = poli1.score1+poli2.score2+poli3.score3+poli4.score4+poli5.score5;
        String score = Integer.toString(a);
        jLabel10.setText(score);
        String name = Login.user;
        int score1 = poli1.score1;
        int score2 = poli2.score2;
        int score3 = poli3.score3;
        int score4 = poli4.score4;
        int score5 = poli5.score5;
        int total = a;
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/game","root","");
           String x = "insert into politician values('"+name+"','"+score1+"','"+score2+"','"+score3+"','"+score4+"','"+score5+"','"+total+"')";
             Statement stmt = con.createStatement();
            int rs = stmt.executeUpdate(x);
