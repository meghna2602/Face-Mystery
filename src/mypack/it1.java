 ...
 * @author shweta
 */
public class it1 extends javax.swing.JFrame {
    int s=0;
    public static int score1;

    /**
     * Creates new form it1
     */
    public it1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Bill-Gates-micrpsoft-3.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 354, 350, 39));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Bill-Gates-micrpsoft-1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 136));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Bill-Gates-micrpsoft-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 422, 350, 125));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Bill-Gates-micrpsoft-2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 286, 350, 68));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 520, 70));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/Bill-Gates-micrpsoft-4.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 350, 42));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("bill gates"))
        {
            ...
            jLabel5.setVisible(true);
            jLabel12.setVisible(true);
            jTextField1.setText("Bill Gates");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(it1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
