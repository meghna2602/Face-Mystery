 ...
 * @author shweta
 */
public class Sports5 extends javax.swing.JFrame {
    int s=0;
    public static int score5;

    /**
     * Creates new form Sports5
     */
    public Sports5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/virat-kohli-1.jpg"))); // NOI18N
        jLabel3.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel3.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 350, 133));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/virat-kohli-2.jpg"))); // NOI18N
        jLabel4.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel4.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 283, 350, 60));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/virat-kohli-4.jpg"))); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel5.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 385, 350, 51));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/virat-kohli-3.jpg"))); // NOI18N
        jLabel12.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel12.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 343, 350, 42));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/virat-kohli-5.jpg"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1000, 500));
        jLabel1.setPreferredSize(new java.awt.Dimension(500, 500));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 436, 350, 114));
        ...
        jLabel17.setText("His nickname is Cheeku.");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 420, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(a.equalsIgnoreCase("Virat kohli"))
        {
            ...
            jLabel12.setVisible(true);
            jLabel22.setVisible(true);
            jTextField1.setText("Virat Kohli");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sports5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
